...
?>
			<li id="link-main">
				<a href="./group.php?id=<?php echo $rs["ID"]?>&glvl=2&gp=<?php 
					$SQL2="
						SELECT * 
						FROM  `GROUP_LV3`
...
?>
							<ul>
								<li><a href="./group.php?id=<?php echo $rs2["ID"]; ?>&glvl=3&gp=<?php 
									$SQL3="
										SELECT * 
										FROM  `GROUP_LV4`
...
?>
												<ul> 
													<li><a href="./group.php?id=<?php echo $rs3["ID"]; ?>&glvl=4&gp=<?php 
														$SQL4="
															SELECT * 
															FROM  `GROUP_LV5`
...
?>
																<ul>
																	<li><a href="./group.php?id=<?php echo $rs4["ID"]; ?>&glvl=5&gp=<?php 
																		$SQL5="
																			SELECT * 
																			FROM  `GROUP_LV6`
...
?>
																					<ul>
																						<li><a href="./group.php?id=<?php echo $rs5["ID"]; ?>&glvl=6&gp=y"><?php echo $rs5["NAME"]; ?></a>
																						</li>
																					</ul>
<?php
																				}
