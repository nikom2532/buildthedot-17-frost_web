        ...
        <div id="content-middle" class="grid_12">
             <div id="profile" >
                ...
                <div class="grid_6" id="profile-detail">      	 
                    <fieldset>
                        <p><input type="text" id="name" class="" value="Lorem Ipsum Lorem Ipsum" /></p>
                        <p><input type="text" id="company" class="" value="Lorem Ipsum Lorem Ipsum" /></p>
                        <p><input type="text" id="email" class="" value="Lorem@Ipsum.com" /></p>
                    </fieldset>
                   		<p id="edit-password"><a href="edit-password.php" >edit password</a></p>
                </div>
                <br class="clear"/>
