...
Donate link: http://mecontact.wordpress.com/mj-contact-us-plugin/
...
<p>MJ Contact us is a simple and easy to integreate with any design and easy to change in coding as per requirement and easy to 
...
these are some of features that this plugin consist</p>
<ul>
<li> - easy to install.</li>
<li> - easy to integrate with any html design</li>
<li> - easy to change html formate as per design requirement.</li>
<li> - easy to manupulate jQuery validations according to requirement</li>
<li> - easy to call using two method one is using shortcode [mjcontactus] and other using paste this code 
   mj_contact_us(); php code</li>
<li> - fast form </li>
...
install the plugin as we install the plugin. use short code [mjcontactus] to call in any page from admin section or call mj_contact_us() functin in any template file to call form directly


e.g.

1. Upload 'mj-contactus' file to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Place `[mjcontactus]` in your page editor or in templates paste this code mj_contact_us();
4. Do the admin setting as per your requirement

== Frequently Asked Questions ==

= can we customize html of contact us form =

yes its very easy to customize html of contact us form

= is this form is compatible with IE versions/ mozilla and chrome =

yes this is totally competible with IE/mozilla and chrome
 ...
 * introduce numeric captcha. like 12 + 2 - 4 = ?
 * file upload and send attachment.
 
= 5.1 =
 * add the jquery validation
 * changes in form design
 * copy to me option added
 * add object and classes
