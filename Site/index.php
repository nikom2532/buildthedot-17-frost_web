    	...
    	<div id="icon">
        	<div class="grid_3 center">
                <a href="#">
                    ...
                    <p class="text-blue bold">Technology</p>
                </a>
            </div>	
            <div class="grid_3 center">
                <a href="#">
                    <img src="images/icon-strategy.png" width="124" height="123" alt="Strategy">
                    <p class="text-blue bold">Strategy</p>
                </a>
            </div>
            <div class="grid_3 center">
            	<a href="#">
            		<img src="images/icon-asean.png" width="127" height="127" alt="Around Asean">
                    <p class="text-blue bold">Around Asean</p>
                </a>
            </div>
            <div class="grid_3 center">
            	<a href="#">
                	<img src="images/icon-best-practice.png" width="124" height="123" alt="Best Practice">
                     <p class="text-blue bold">Best Practice</p>
                </a>
             </div>
