...
<div id="content">
	...
	<div class="page-full-width cf">
		<div class="content-module">
			...
			<div style="margin-top: 15px; margin-bottom: 15px; margin-left: 15px;"><a href="./customer.php">Customer Management</a> --&gt; <a href="#" onclick="window.history.back(); ">Customer Download</a> --&gt; PDF Detail</div>
...
?>
						<fieldset>
							<p>
								...
								<input type="text" name="name" id="name" class="round full-width-input" value="<?=$row['name']; ?>" disabled="disabled" />
							</p>
							<p>
								<label for="description">Description</label>
								<textarea name="description" id="description" class="round full-width-textarea" disabled="disabled" ><?=$row['description']; ?></textarea>
							</p>
							<p>
								<label for="price">Price</label>
								<input type="text" name="price" id="price" class="round full-width-input" value="<?=$row['price']; ?>" disabled="disabled"/>
							</p>
							<p>
								<label for="asian">Asian country</label>
								<input type="radio" name="asian" id="asian" value="0" checked="checked" disabled="disabled">
								No
								<br>
								<input type="radio" name="asian" id="asian" value="1" disabled="disabled">
								Yes
								<br>
							</p>
<?php
...
?>
              		...
              		<p><label for="tag">Tag</label></p>
									<input type="text" id="tags" name="tags" disabled="disabled" value="<?php
              ...
              <p class="form-error-input">
          	  ...
          	  */ ?>
						...
						<!-- <input type="submit" id="tags_val" name="tags_val" value="Save change" class="round blue ic-right-arrow" disabled="disabled" /> -->
					</div>
				</form>
			<!-- end half-size-column -->
